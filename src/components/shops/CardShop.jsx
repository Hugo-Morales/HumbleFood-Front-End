  ...
  return (
    <>
      <div className="flex justify-center items-center w-full drop-shadow-4xl">
        <div className="relative bg-white shadow-md  h-32 mx-3 rounded-3xl  flex flex-col justify-around items-center overflow-hidden sm:flex-row sm:h-32 sm:w-3/5 md:w-96">
          <img
