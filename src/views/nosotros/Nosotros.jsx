      ...
      <div className="bg-gradient-to-r from-green-400 to-blue-500   flex justify-center mx-auto pt-12">
        <div>
          ...
          <h1 className="xl:text-4xl text-3xl text-center text-white font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">
            Conoce a las personas talentosas detrás de la construcción de
            Humblefood.
          </h1>
        </div>
      </div>
              ...
              <div className="rounded overflow-hidden shadow-md bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <a
                      href="https://github.com/Danieljra"
                      target="_blank"
                      rel="noreferrer"
                      className="mx-5"
                    >
                    ...
                    <a
                      href="https://twitter.com/Daniel_RA0"
                      target="_blank"
                      rel="noreferrer"
                      className="mx-5"
                    >
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded overflow-hidden shadow-md bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <a
                      href="https://github.com/diemora473"
                      target="_blank"
                      rel="noreferrer"
                      className="mx-5"
                    >
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded overflow-hidden shadow-md bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <a
                      href="https://github.com/LuchoFS96"
                      target="_blank"
                      rel="noreferrer"
                      className="mx-5"
                    >
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded overflow-hidden shadow-md bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <a
                      href="https://github.com/DemIGoD45"
                      target="_blank"
                      rel="noreferrer"
                      className="mx-5"
                    >
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded overflow-hidden shadow-md bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <a
                      href="https://github.com/Tatino12"
                      target="_blank"
                      rel="noreferrer"
                      className="mx-5"
                    >
                    ...
                    <a
                      href="https://twitter.com/CryptoTuru"
                      target="_blank"
                      rel="noreferrer"
                      className="mx-5"
                    >
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded overflow-hidden shadow-md bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <a
                      href="https://github.com/Hugo-Morales"
                      target="_blank"
                      rel="noreferrer"
                      className="mx-5"
                    >
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5 ">
              <div className="rounded overflow-hidden shadow-md bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <a
                      href="https://github.com/ethanial1"
                      target="_blank"
                      rel="noreferrer"
                      className="mx-5"
                    >
