        ...
        <div className="flex min-h-screen text-center md:block md:px-2 lg:px-4" >
          ...
          <div className="flex text-base text-left transform transition w-full md:inline-block md:max-w-2xl md:px-4 md:my-8 md:align-middle lg:max-w-4xl">
            <div className="w-full relative flex items-center bg-white px-4 pt-14 pb-8 overflow-hidden shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
              <Link to='/'>
                <button type="button" className="absolute top-4 right-4 text-gray-400 hover:text-gray-500 sm:top-8 sm:right-6 md:top-6 md:right-6 lg:top-8 lg:right-8 p-2 h-10 focus:outline-none bg-ochre hover:bg-princetonWhite font-bold border-none">
              ...
              <div className="w-full grid grid-cols-1 gap-y-8 gap-x-6 items-start sm:grid-cols-12 lg:gap-x-8">
                <div className="aspect-w-2 aspect-h-3 rounded-lg bg-gray-100 overflow-hidden sm:col-span-4 lg:col-span-5">
                  <img src={data[id].image} alt="Two each of gray, white, and black shirts arranged on table." className="object-center object-cover" />
                </div>
                <div className="sm:col-span-8 lg:col-span-7">
                  <h2 className="text-2xl font-extrabold text-gray-900 sm:pr-12 font-poppins w-full h-16 bg-ochre flex justify-between">{data[id].restaurante}</h2>
                  <h2 className="text-2xl font-extrabold text-gray-900 sm:pr-12">{data[id].nombre} {data[id].descuento} %Off</h2>
                  ...
                  >
                    ...
                    <div className="mt-6">
                      ...
                      <div className="flex items-center">
                        ...
                        {/* <p className="sr-only">3.9 out of 5 stars</p>
>>>>>>> c9f1c85799d83d02d11ce2d62ce03e5ea2c7130a:src/views/CardDetails.jsx
