                    ...
                    <div className="md:grid md:grid-cols-3 md:gap-6">
                        ...
                        <div className="mt-5 md:mt-0 md:col-span-2">
                                ...
                                <div className="px-4 py-5 bg-white sm:p-6">
                                    <div className="grid grid-cols-6 gap-6">
                                        ...
                                        <div className="col-span-6 sm:col-span-3" >
                                            ...
                                            <select id="categories" name="categories" onChange={handleSelect} autoComplete="categories" className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                        ...
                                        <div>
                                            <label htmlFor="description" className="block text-sm font-medium text-gray-700"> About </label>
                                            <div className="mt-1">
                            ...
                            <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                <input type="submit" className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" value='send' required />
