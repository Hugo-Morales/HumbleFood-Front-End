    ...
    <div className="relative min-h-screen flex">
      <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
        ...
        <div className="sm:w-1/2 xl:w-1/2 h-full hidden md:flex flex-auto items-center justify-center overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative fondo_user">
          ...
          <div className="w-full w-96 z-10 justify-center items-center">
        ...
        {/* Parte Derecha User */}
        <div className="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full w-1/2 xl:w-1/2 p-8 md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white fondo_rest">
