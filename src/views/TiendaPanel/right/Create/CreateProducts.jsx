                        ...
                        <div className="shadow overflow-hidden sm:rounded-md">
                            <div className="px-4 py-5 bg-white sm:p-6">
                                <div className="grid grid-cols-6 gap-6">
                                    {/* Input Nombre */}
                                    <Input div='col-span-6 sm:col-span-3 font-bold' forid='first-name' lclass='block text-sm uppercase' tl='Nombre del Producto' it='text' iname='name' iId='first-name' iclass='mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 border-2 rounded-md' valor={input.name} c={handleChange} ediv='text-rose-800' err={errors.name} />

                                    {/* Input Precio */}
                                    <Input div='col-span-1 font-bold' forid='price' lclass='block text-sm uppercase' tl='Precio $' it='number' iname='price' iId='price' iclass='mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 sm:text-sm border-gray-300 border-2 rounded-md' valor={input.price} c={handleChange} ediv='text-rose-800' err={errors.price} />

                                    {/* Input Descuento */}
                                    <Input div='col-span-1 font-bold' forid='discount' lclass='block text-sm uppercase' tl='Descuento %' it='number' iname='discount' iId='discount' iclass='mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 sm:text-sm border-gray-300 border-2 rounded-md' valor={input.discount} c={handleChange} ediv='text-rose-800' err={errors.discount} />

                                    {/* Input Stock */}
                                    <Input div='col-span-1 font-bold' forid='stock' lclass='block text-sm uppercase' tl='Stock' it='number' iname='stock' iId='stock' iclass='mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 sm:text-sm border-gray-300 border-2 rounded-md' valor={input.stock} c={handleChange} ediv='text-rose-800' err={errors.stock} />

                                    {/* TextArea Description */}
                                    <div className='col-span-6 sm:col-span-3'>
                                        <label htmlFor="description" className="font-bold"> Descripción </label>
                                        <div className="mt-1">
                                            <textarea id="description" name="description" rows="3" className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md resize-none" placeholder="Descripción del productos (Ej. Los ingredientes)"
                                                type="text"
                                    ...
                                    <div className="col-span-6 sm:col-span-6" >
                                        <label htmlFor="categories" className="font-bold">Categorías</label>
